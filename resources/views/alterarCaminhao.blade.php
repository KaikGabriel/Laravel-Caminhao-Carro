  ...
  <div class="container cadastroCaminhao">
    <form class="row g-3" method="post" action="{{route('salvar-banco')}}">
      ...
      <div class="col-md-12">
        ...
        <input type="text" name="cor" value="{{old('cor')}}" class="form-control" id="inputCor" placeholder="Amarelo">
        @error('cor')
      ...
      <div class="col-md-12">
        ...
        <input type="text" name="valor" value="{{old('valor')}}" class="form-control" id="inputValor" placeholder="R$ 25.660,23">
        @error('valor')
